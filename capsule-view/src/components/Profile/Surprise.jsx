  ...
  return (
    ...
    <div className="capsule-container">
      <div className='capsule-box'> 
            <button className='quit-button' onClick={onclose}>X</button>
...
{capsule.voice && (
  <audio controls>
    ...
    ...
          ...
          <button
    className='view-button surprise-button' onClick={handleDownload}>Download</button>
          <button onClick={ async()=>{
               try {
      await axios.post(`http://127.0.0.1:8000/api/v0.1/user/surpriseCapsule`, {
        id:capsuleId,
      ...
      console.error("Failed to update capsule date:", error);
            ...
            }} className='view-button surprise-button'>Surprise mode</button>
